        ...
        while($row = mysqli_fetch_assoc($result)){
            ...
            echo '<td class="td-actions">
                    <form action="" method="POST">
                        <button rel="tooltip" title="Editar" class="btn btn-primary btn-simple btn-xs" type="submit" name="delete" value="'.$row["idProveedor"].'"><i class="material-icons">edit</i>
                    </button>
                    </form>
                    <form action="delete.php" method="POST">
                        <button rel="tooltip" title="Eliminar" class="btn btn-danger btn-simple btn-xs" type="submit" name="action" value="'.$row["idProveedor"].'"><i class="material-icons">close</i>
                        </button>
                    </form>
                  </td>';
            echo '</tr>';
